...
class OllamaChat:
    ...
    def __init__(self, model: str = "qwen3:30b-a3b", max_context_tokens: int = 120_000):
        self.model = model
    ...
    def _build_messages(self) -> List[Dict[str, str]]:
        ...
        Build the list of messages to send to Ollama, including:
          ...
          - One system message with the document context (if any).
    ...
    def stream_chat(self, user_message: str, temperature: float = 0.7):
        ...
        Streaming chat generator for use by servers:
          ...
          for chunk in ollama_chat.stream_chat("hello"):
              ...
        ...
        try:
            ...
            for chunk in stream:
                ...
                if text:
                    full_response += text
                    yield text  # send chunk to caller
